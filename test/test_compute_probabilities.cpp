...
using blackjack::computeExpectationAfterPlayer;
using blackjack::computeExpectationAfterStartingHand;
using blackjack::computeExpectationAfterOpenCards;
...
namespace
{
    Expectation probabilityForFourSixAgainstNineSeven()
    {
        Expectation probability;
        probability.axpy( 4.0 / 48, Expectation{29.0 / 47, 0, 18.0 / 47, 11.0 / 47} );        // 2
        probability.axpy( 4.0 / 48, Expectation{29.0 / 47, 0, 18.0 / 47, 11.0 / 47} );        // 3
        probability.axpy( 3.0 / 48, Expectation{29.0 / 47, 0, 18.0 / 47, 11.0 / 47} );        // 4
        probability.axpy( 4.0 / 48, Expectation{29.0 / 47, 0, 18.0 / 47, 11.0 / 47} );        // 5
        probability.axpy( 3.0 / 48, Expectation{28.0 / 47, 0, 19.0 / 47, 9.0 / 47} );         // 6
        probability.axpy( 3.0 / 48, Expectation{28.0 / 47, 4.0 / 47, 15.0 / 47, 13.0 / 47} ); // 7
        probability.axpy( 4.0 / 48, Expectation{32.0 / 47, 4.0 / 47, 11.0 / 47, 21.0 / 47} ); // 8
        probability.axpy( 3.0 / 48, Expectation{36.0 / 47, 4.0 / 47, 7.0 / 47, 29.0 / 47} );  // 9
        probability.axpy( 16.0 / 48, Expectation{40.0 / 47, 3.0 / 47, 4.0 / 47, 36.0 / 47} ); // 10
        probability.axpy( 4.0 / 48, Expectation{43.0 / 47, 4.0 / 47, 0.0, 43.0 / 47} );       // A
        probability.payout *= 2; // double down
        std::cout << probability << std::endl;
        return probability;
    }

    Expectation probabilityForFourSixAgainstNineSix()
    {
        // clang-format off
        Expectation probability;
        probability.axpy(  4.0 / 48, Expectation{27.0/47 + 4*29.0/(47*46),
                                                 0,
        ...
        probability.axpy(  3.0 / 48, Expectation{27.0/47 + 4*29.0/(47*46),
                                                 0,
                                                 16.0/47 + 4*17.0/(47*46),
        ...
        probability.axpy(  2.0 / 48, Expectation{27.0/47 + 4*28.0/(47*46),
                                                 0,
                                                 16.0/47 + 4*18.0/(47*46),
                                                 11.0/47 + 4*10.0/(47*46)} ); // 6
        probability.axpy(  4.0 / 48, Expectation{26.0/47 + 4*28.0/(47*46),
                                                 4.0*49.0/(47*46),
                                                 13.0/47 + 4*15.0/(47*46),
                                                 13.0/47 + 4*13.0/(47*46)} ); // 7
        probability.axpy(  4.0 / 48, Expectation{30.0/47 + 4*31.0/(47*46),
                                                 4.0*50.0/(47*46),
                                                  9.0/47 + 4*11.0/(47*46),
                                                 21.0/47 + 4*20.0/(47*46)} ); // 8
        probability.axpy(  3.0 / 48, Expectation{34.0/47 + 4*35.0/(47*46),
                                                 (3.0*46 + 16.0)/(47*46),
                                                  6.0/47 +  4*7.0/(47*46),
                                                 28.0/47 + 4*28.0/(47*46)} ); // 9
        probability.axpy( 16.0 / 48, Expectation{37.0/47 + 4*39.0/(47*46),
                                                 4.0*49.0/(47*46),
                                                  2.0/47 +   4*4.0/(47*46),
                                                 35.0/47 + 4*35.0/(47*46)} ); // 10
        probability.axpy(  4.0 / 48, Expectation{42.0/47 + 3*42.0/(47*46),
                                                 2.0*52.0/(47*46),
                                                 0.0,
    ...
    // clang-format off
    std::map< std::pair< Hand, Hand >, Expectation > expectedProbability{
        { {{Card::_4, Card::_6}, {Card::_9, Card::_A}},  Expectation{ 3.0 / 48, 16.0 / 48, 29.0 / 48, -26.0 / 24} },
        { {{Card::_4, Card::_6}, {Card::_9, Card::_10}}, Expectation{19.0 / 48,  3.0 / 48, 26.0 / 48, -7.0 / 24} },
        { {{Card::_4, Card::_6}, {Card::_9, Card::_9}},  Expectation{22.0 / 48,  4.0 / 48, 22.0 / 48,  0.0} },
        { {{Card::_4, Card::_6}, {Card::_9, Card::_8}},  Expectation{26.0 / 48,  4.0 / 48, 18.0 / 48,  8.0 / 24} },
    ...
    std::map< std::pair< Hand, Hand >, Expectation > expectedProbabilityAfterPlayer{
        { {{Card::_6, Card::_10},          {Card::_6, Card::_10}}, Expectation{7.0 / 12, 0, 5.0 / 12, 2.0 / 12} },
        { {{Card::_4, Card::_6, Card::_2}, {Card::_9, Card::_6}},  Expectation{( 27.0*46 + 4*29 ) / (47*46),
                                                                               0,
                                                                               ( 16.0*46 + 4*17 ) / (47*46),
                                                                               (11.0*46 + 4*12) / (47*46)} },
        { {{Card::_4, Card::_6, Card::_3}, {Card::_9, Card::_6}},  Expectation{( 27.0*46 + 4*29 ) / (47*46),
                                                                               0,
                                                                               ( 16.0*46 + 4*17 ) / (47*46),
                                                                               (11.0*46 + 4*12) / (47*46)} },
        { {{Card::_4, Card::_6, Card::_4}, {Card::_9, Card::_6}},  Expectation{( 27.0*46 + 4*29 ) / (47*46),
                                                                               0,
                                                                               ( 16.0*46 + 4*17 ) / (47*46),
                                                                               (11.0*46 + 4*12) / (47*46)} },
        { {{Card::_4, Card::_6, Card::_5}, {Card::_9, Card::_6}},  Expectation{( 27.0*46 + 4*29 ) / (47*46),
                                                                               0,
                                                                               ( 16.0*46 + 4*17 ) / (47*46),
                                                                               (11.0*46 + 4*12) / (47*46)} },
        { {{Card::_4, Card::_6, Card::_6}, {Card::_9, Card::_6}},  Expectation{( 27.0*46 + 4*28 ) / (47*46),
                                                                               0,
                                                                               ( 16.0*46 + 4*18 ) / (47*46),
                                                                               (11.0*46 + 4*10) / (47*46)} },
        { {{Card::_4, Card::_6, Card::_7}, {Card::_9, Card::_6}},  Expectation{( 26.0*46 + 4*28 ) / (47*46),
                                                                               4*49.0/(47*46),
                                                                               ( 13.0*46 + 4*15 ) / (47*46),
                                                                               (13.0*46 + 4*13) / (47*46)} },
        { {{Card::_4, Card::_6, Card::_8}, {Card::_9, Card::_6}},  Expectation{( 30.0*46 + 4*31 ) / (47*46),
                                                                               4*50.0/(47*46),
                                                                               ( 9.0*46 + 4*11 ) / (47*46),
                                                                               (21.0*46 + 4*20) / (47*46)} },
        { {{Card::_4, Card::_6, Card::_9}, {Card::_9, Card::_6}},  Expectation{( 34.0*46 + 4*35 ) / (47*46),
                                                                               (3*46.0+16)/(47*46),
                                                                               ( 6.0*46 + 4*7 ) / (47*46),
                                                                               (28.0*46 + 4*28) / (47*46)} },
        { {{Card::_4, Card::_6, Card::_10}, {Card::_9, Card::_6}},  Expectation{( 37.0*46 + 4*39 ) / (47*46),
                                                                               4*49.0/(47*46),
                                                                               ( 2.0*46 + 4*4 ) / (47*46),
                                                                               (35.0*46 + 4*35) / (47*46)} },
        { {{Card::_4, Card::_6, Card::_A}, {Card::_9, Card::_6}},  Expectation{( 42.0*46 + 3*42 ) / (47*46),
                                                                               (2*46+12.0)/(47*46),
                                                                               0,
                                                                               ( 42.0*46 + 3*42 ) / (47*46)} },
        { {{Card::_4, Card::_6, Card::_2}, {Card::_9, Card::_5}},
            Expectation{( 23.0*46*45 + (4*27 + 3*30)*45 + 4*3*30 ) / (47*46*45),
                        0,
                        ( 17.0*46*45 + (4*16 + 3*16)*45 + 4*3*15 ) / (47*46*45),
                        ( 6.0*46*45 + (4*11 + 3*14)*45 + 4*3*15 ) / (47*46*45)} },
        { {{Card::_4, Card::_6, Card::_3}, {Card::_9, Card::_5}},
            Expectation{( 23.0*46*45 + (4*27 + 4*30)*45 + 4*3*30 ) / (47*46*45),
                        0,
        ...
        { {{Card::_4, Card::_6, Card::_A}, {Card::_9, Card::_5}},
            Expectation{36.0/47 + 3.0/47*41.0/46 + 3.0/47*2.0/46*42.0/45 + 4.0/47*43.0/46,
...
TEST_F( TestDealerProbabilities, PlayerHasSixAndTen_DealerHasSixAndTen_BustProbability )
{
    ...
    const auto probability = computeExpectationAfterPlayer( player, dealer, deck );
    ...
    EXPECT_THAT( probability.payout, DoubleEq( expectation.payout * betSize ) );
}
...
TEST_F( TestDealerProbabilities, PlayerHasSixAndTen_DealerHasFiveAndTen_BustProbability )
{
    ...
    EXPECT_THAT( probability.payout, DoubleEq( ( 1.0 / 6 + 11.0 / ( 12 * 47 ) ) * betSize ) );
}
...
TEST_F( TestProbabilities, PlayerHasFourAndSix_DealerHasNineAndAce_DoubleDown )
{
    ...
    const auto probability = computeExpectationAfterStartingHand( player, dealer, deck, rules );
...
TEST_F( TestProbabilities, PlayerHasFourAndSix_DealerHasNineAndNine_DoubleDown )
{
    ...
    EXPECT_THAT( probability.tie, DoubleEq( expectation.tie ) );
    EXPECT_THAT( probability.loss, DoubleEq( expectation.loss ) );
    EXPECT_THAT( probability.payout, DoubleNear( expectation.payout * betSize,
...
//    EXPECT_THAT(probability.payout, Eq(-26.0/24*betSize));
//}
